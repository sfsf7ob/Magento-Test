...
namespace Ced\SmsaShipping\Block;
/**
...
class Extensions extends \Magento\Config\Block\System\Config\Form\Fieldset  
{
    ...
    public function __construct(
        ...
        $this->_helper = $this->_objectManager->get('Ced\SmsaShipping\Helper\Data');
    ...
    public function render(\Magento\Framework\Data\Form\Element\AbstractElement $element)
    {
		...
		$modules =  $this->_objectManager->get('\Ced\SmsaShipping\Helper\Feed')->getAllModules();
    ...
    {
    	$hash = \Ced\SmsaShipping\Block\Extensions::HASH_PATH_PREFIX.strtolower($moduleName).'_hash';	
    	$level = \Ced\SmsaShipping\Block\Extensions::HASH_PATH_PREFIX.strtolower($moduleName).'_level';

	 	$helper = $this->_objectManager->create('\Ced\SmsaShipping\Helper\Data');
		...
		$l = $this->_objectManager->create('\Ced\SmsaShipping\Helper\Feed')->getLicenseFromHash($hash,$level);
    ...
    public function getLicenseUrl()
    {
        ...
        //echo $this->geturl('smsashipping/main/license');die('bbbb');
        return $this->geturl('smsashipping/main/license');
    }
	/*
