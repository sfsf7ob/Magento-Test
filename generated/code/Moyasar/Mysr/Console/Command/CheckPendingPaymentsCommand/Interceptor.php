<?php
namespace Moyasar\Mysr\Console\Command\CheckPendingPaymentsCommand;

/**
 * Interceptor class for @see \Moyasar\Mysr\Console\Command\CheckPendingPaymentsCommand
 */
class Interceptor extends \Moyasar\Mysr\Console\Command\CheckPendingPaymentsCommand implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'cron');
        return $pluginInfo ? $this->___callPlugins('cron', func_get_args(), $pluginInfo) : parent::cron();
    }
