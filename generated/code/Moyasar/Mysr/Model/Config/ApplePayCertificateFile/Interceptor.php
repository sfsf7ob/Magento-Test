<?php
namespace Moyasar\Mysr\Model\Config\ApplePayCertificateFile;

/**
 * Interceptor class for @see \Moyasar\Mysr\Model\Config\ApplePayCertificateFile
 */
class Interceptor extends \Moyasar\Mysr\Model\Config\ApplePayCertificateFile implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function validateMaxSize($filePath)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('validateMaxSize', func_get_args(), $pluginInfo) : parent::validateMaxSize($filePath);
    }
